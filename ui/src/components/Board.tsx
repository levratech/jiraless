...
type BoardData = Record<string, { id: string; title: string; type: string[]; priority?: string; assignees?: string[] }[]>
...
function Card({ id, title, type, priority, assignees }: { id: string; title: string; type: string[]; priority?: string; assignees?: string[] }) {
  return (
          ...
          return (
            <span key={t}
              style={{
                ...
                background: `${meta?.color || '#e5e7eb'}22`, border: `1px solid ${meta?.color || '#e5e7eb'}`,
